...
public class Playlist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnFooter.setPreferredSize(new java.awt.Dimension(636, 50));
    ...
    private void tblPlaylistMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPlaylistMouseClicked
        ...
        if (evt.getClickCount() == 2 && i != 1) {
            ...
            JOptionPane.showMessageDialog(this,
                    ...
                    + "trr { border-bottom:1pt solid black; }"
                    + "</style>"
                    + "</head>"
                    + "<body>"
                    + "<h3>Detail Musik:</h3>"
    ...
    private void addFilesStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_addFilesStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_addFilesStateChanged
